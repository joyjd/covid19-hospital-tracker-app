...
import "./../LocationInputOptionModals/LocationOptionInput.style.scss";
          ...
          <div className='shadowCustom locBodyHolder'>
            <Paper elevation={3}>
              ...
              <div className='locPromptbody'>
                <div>We can trace your current location based on the address details you provide.But for more accuracy, we strongly insist you to enable device-location permission in your device.</div>
